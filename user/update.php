...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <a class="nav-link" href="user/' . $_SESSION[''] . '">Profile</a>
                </div>';
                        }
                        ?>
                    ...
                    <div class="ibox-content forum-container">
                        <form action="action.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="Mail" class="form-control" id="Mail" value="<?= $user['Mail'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="Role" class="form-label">Role : </label>
                                <input type="text" name="Role" class="form-control" id="Role" value="<?= $user['Role'] ?>">
                            </div>
                            <input type="submit" class="btn btn-warning" name="btn_update" value="Modifier">
                        </form>
                    </div>
